...
//Code Here
let evenNumbers = mixedNumbers.filter(function(ele, i, mixedNumbers){
  return ele % 2 === 0
})
...
//Code Here
let postTaxPrices = prices.map(function(ele, i, prices){
  return ele * 1.07
});
...
let orderTotals  = orders.map(function(val, i){
